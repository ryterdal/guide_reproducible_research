...
inspect and modify the code. See the {ref}`open-source-license` section for
more details.


### For Articles, Data, and Other Outputs
...
Review the {ref}`open-licenses` section to learn more about publishing your
